...
* [Code Standards](#code-standards)
  ...
  - [5. Function Declarations](#5-function-declarations)
  - [6. Types](#6-types)
    - [Constants](#constants)
    - [Optionals](#optionals)
  - [7. Classes vs Structs](#7-classes-vs-structs)
    - [Which one to use?](#which-one-to-use)
    - [Final](#final)
  - [Useful Links](#useful-links)
* [Code Review](#code-review)
  - [What is a code review?](#what-is-a-code-review)
  - [Why is performing a code review important?](#why-is-performing-a-code-review-important)
  - [Steps of a good code review process](#steps-of-a-good-code-review-process)
